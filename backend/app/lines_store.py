...
class LinesStore:
    def __init__(self) -> None:
        ...
        self._file_path = self._data_dir / "lines.json"
        self._seed_data = [
            {"id": 1, "code": "FRM-L1", "name": "Frame Line 1", "department_code": "FRAME", "is_active": True},
            {"id": 2, "code": "LNS-L1", "name": "Lens Coating Line 1", "department_code": "LENS", "is_active": True},
            {"id": 3, "code": "QC-L1", "name": "Final QC Line", "department_code": "QC", "is_active": True},
        ]
    ...
    def create(self, payload: dict[str, Any]) -> dict[str, Any]:
        with self._lock:
            ...
            created = {
                ...
                "department_code": str(payload["department_code"]).strip().upper(),
    ...
    def update_by_code(self, code: str, payload: dict[str, Any]) -> dict[str, Any] | None:
        with self._lock:
            ...
            if "department_code" in payload:
                current["department_code"] = str(payload["department_code"]).strip().upper()
